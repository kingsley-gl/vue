	...
	export default{
		data (){
			return{
					...
					maintext:[
							{id:'1',text:"公安局",address:'广州金溪阿斯阿斯是阿萨德撒旦'},
							{id:'2',text:"公安局2",address:'广州金溪阿斯阿斯是阿萨德撒旦'},
							{id:'3',text:"公安局3",address:'广州金溪阿斯阿斯是阿萨德撒旦'},
							{id:'4',text:"公安局4",address:'广州金溪阿斯阿斯是阿萨德撒旦'},
							{id:'5',text:"公安局5",address:'广州金溪阿斯阿斯是阿萨德撒旦'},
							{id:'6',text:"公安局6",address:'广州金溪阿斯阿斯是阿萨德撒旦'},
							{id:'6',text:"公安局6",address:'广州金溪阿斯阿斯是阿萨德撒旦'},
							{id:'6',text:"公安局6",address:'广州金溪阿斯阿斯是阿萨德撒旦'},
							{id:'6',text:"公安局6",address:'广州金溪阿斯阿斯是阿萨德撒旦'},
							{id:'6',text:"公安局6",address:'广州金溪阿斯阿斯是阿萨德撒旦'},

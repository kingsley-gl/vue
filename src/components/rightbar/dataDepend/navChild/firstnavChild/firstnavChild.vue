<template>
	<div class="warp">
		...
		<div class="main">
			<div class="sidebar">
				<ul>
					<li @click=""><i class="el-icon-star-on iconcss"></i>{{mainKind[0]}}</li>
					<li @click=""><i class="el-icon-star-on iconcss"></i>{{mainKind[1]}}</li>
					<li @click=""><i class="el-icon-star-on iconcss"></i>{{mainKind[2]}}</li>
					<li @click=""><i class="el-icon-star-on iconcss"></i>{{mainKind[3]}}</li>
					<li @click=""><i class="el-icon-star-on iconcss"></i>{{mainKind[4]}}</li>
				</ul>
			...
			<div class="maintable">
				<li class="licss" v-for="(items,index) in maintext">
					<div><i class="el-icon-star-on iconcss"></i>{{items.text}}</div>
				</li>
			</div>
	...
	export default{
		data (){
			return{
					...
					currentPage:1,
					pageSize:3,
					mainKind:["流程分类一","流程分类二","流程分类三","流程分类四","流程分类五"],
					maintext:[
							{id:'1',text:"xxxxx充值流程"},
							{id:'2',text:"xxxxx充值流程"},
							{id:'3',text:"xxxxx充值流程"},
